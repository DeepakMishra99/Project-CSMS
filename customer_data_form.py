...
def cust_insert():
    ...
    def insert():
        ...
        if len(a)==0 or len(b)==0 or len(c)==0 or len(d)==0 or len(e)==0 or len(f)==0 or len(g)==0:
            ...
            s="insert into customer values('%s','%s','%s','%s','%s','%s','%s')"%(a,b,c,d,e,f,g)
            cur.execute(s)
            db.commit()
    ...
    c.place(x=200, y=30)
    c.create_text(250,20,text='Insert Customer',font=('Copperplate Gothic Bold',20),fill='yellow green')
        
    l1=Label(t,text='Customer Id', fg='black',bg='light blue', font=('Arial Rounded MT Bold',15))
    l1.place(x=100,y=150)
    e1=Entry(t,width=30,bd=2,relief='groove', font=('Arial Rounded MT Bold',14))
    e1.place(x=350,y=150)
    l2=Label(t,text='Customer Name', fg='black',bg='light blue', font=('Arial Rounded MT Bold',15))
    ...
    data1=fill_pcatid()
    e6['values']=data1
    l7=Label(t,text='Product Id', fg='black',bg='light blue', font=('Arial Rounded MT Bold',15))
...
def cust_delete():
    ...
    def de():
       ...
       x=str(e1.get())
       if len(x)==0:
             messagebox.showinfo("Delete","Customer Id Entry is empty. \n Please fill first.")
       else:
           s="delete from customer where custid='%s'"%(x)
           cur.execute(s)
           db.commit()
    ...
    c=Canvas(t,width=500,height=40,bg='grey20')
    c.place(x=150, y=30)
    c.create_text(250,20,text='Delete Customer',font=('Copperplate Gothic Bold',20),fill='yellow green')
    l1=Label(t,text='Customer Id', fg='black',bg='light blue', font=('Arial Rounded MT Bold',16))
    l1.place(x=100,y=150)
...
def cust_update():
    ...
    def updatedata():
        ...
        if len(a)==0 or len(b)==0 or len(c)==0 or len(d)==0 or len(e)==0 or len(f)==0 or len(g)==0:
            ...
            s="update customer set cust_name='%s',phone='%s',address='%s',email='%s',pcatid='%s',pid='%s' where custid='%s'"%(b,c,d,e,f,g,a)
            cur.execute(s)
            db.commit()
    ...
    def finddata():
        ...
        x=str(e1.get())
        if len(x)==0:
              messagebox.showinfo("Find","Customer Id Entry is empty. \n Please fill first.")
        else:
            s="select cust_name,phone,address,email,pcatid,pid from customer where custid='%s'"%(x)
            cur.execute(s)
            data=cur.fetchone()
    ...
    c=Canvas(t,width=500,height=40,bg='grey20')
    c.place(x=150, y=30)
    c.create_text(250,20,text='Update Customer',font=('Copperplate Gothic Bold',20),fill='yellow green')
    l1=Label(t,text='Customer Id', fg='black',bg='light blue', font=('Arial Rounded MT Bold',15))
    l1.place(x=100,y=150)
    e1=ttk.Combobox(t,width=20)
    e1.place(x=350,y=150)
...
# find
    ...
    c=Canvas(t,width=500,height=40,bg='grey20')
    c.place(x=150, y=30)
    c.create_text(250,20,text='Find Customer',font=('Copperplate Gothic Bold',20),fill='yellow green')
    l1=Label(t,text='Customer Id', fg='black',bg='light blue', font=('Arial Rounded MT Bold',15))
    l1.place(x=100,y=150)
    e1=ttk.Combobox(t,width=20)
    e1.place(x=350,y=150)
